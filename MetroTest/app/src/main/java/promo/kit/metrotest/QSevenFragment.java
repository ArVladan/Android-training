...
public class QSevenFragment extends Fragment {
    ...
    @BindView(R.id.floatButton7)
    FloatingActionButton fab;
    @BindView(R.id.save_text7)
    ...
    @OnClick(R.id.save_text7)
    public void onSaveText(View view) {
        outText.setText(editText.getText());
        try {
            ContentValues cv = new ContentValues();
            cv.put(DatabaseHelper.COLUMN_ANSWER_7, outText.getText().toString());
